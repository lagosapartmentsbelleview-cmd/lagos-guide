...
/* 
   O site principal deve abrir em PT por defeito,
   mas respeitar ?lang= e window.currentLang se existirem.
*/
let lang =
...
/* ============================================================
   RENDERIZAR RODAPÉ MULTILÍNGUA
============================================================ */
function updateFooterLinksSite() {
  const container = document.querySelector(".footer-links");
  if (!container) return;

  const links = footerLinksSite[lang] || footerLinksSite["pt"];
